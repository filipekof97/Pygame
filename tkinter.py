...
class Janela(tk.Frame):
    ...
    def criar_widgets(self):
        ...
        # Treeview.
        self.treeview = tk.ttk.Treeview(frame2, columns=('N° documento', 'Assunto', 'Data'))
    ...
    def adicionar_registro(self):
        ...
        if validar_data:
            ...
            tk.messagebox.showerror('Erro', 'Padrão de data incorreto, utilize dd/mm/yyyy')

    def excluir_registro(self):
        # Verificando se algum item está selecionado.
        if not self.treeview.focus():
            tk.messagebox.showerror('Erro', 'Nenhum item selecionado')
        else:
